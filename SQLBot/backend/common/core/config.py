...
class Settings(BaseSettings):
    ...
    # OpenRouter Model Override Configuration
    # These settings hardcode the model to always use OpenRouter gpt-oss-120b
    OPENROUTER_MODEL_NAME: str = "openai/gpt-oss-120b"
    OPENROUTER_API_KEY: str = ""  # Will be loaded from .env file automatically
